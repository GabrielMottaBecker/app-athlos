...
class MemberRepository {
  ...
  final List<MemberModel> _members = [
    const MemberModel(id: '1', rank: 1, name: 'Gabriel Breier', role: 'PRESIDENTE', status: 'ATIVO', email: 'gabriel@atletica.com', ra: '100001', curso: 'Administração', senha: '123456'),
    ...
    const MemberModel(id: '6', rank: 6, name: 'Você (Gustavo)', role: 'MEMBRO', status: 'ATIVO', email: 'gustavo@atletica.com', ra: '100006', curso: 'Ciência da Computação', senha: '123456'),
    ...
    const MemberModel(id: '11', rank: 11, name: 'Jailson Mendes', role: 'ADMIN', status: 'ATIVO', email: 'jailsonmendes@atletica.com', ra: '100012', curso: 'Psicologia', senha: '123456'),
  ];
