...
class MemberRepository {
  ...
  final List<MemberModel> _members = [
    ...
    const MemberModel(id: '6', rank: 6, name: 'Você (Gustavo)', role: 'MEMBRO', status: 'ATIVO', email: 'gustavo@atletica.com', ra: '100006', curso: 'Ciência da Computação', isCurrentUser: true, senha: ' '),
    ...
    const MemberModel(id: '11', rank: 11, name: 'Jailson Mendes', role: 'ADMIN', status: 'ATIVO', email: 'jailsomendes@atletica.com', ra: '100012', curso: 'Psicologia', isAdmin: true, senha: '123456'),
  ];
